    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M9 5a2 2 0 012 2h2a2 2 0 002-2"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M9 19a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"
        />
      </svg>
    ),
  },
    ...
    <aside className="sidebar">
      <nav>
        {menuItems.map((item) => (
          ...
          >
            <span className="icon" style={{ width: '24px', height: '24px' }}>
              {item.icon}
            </span>
